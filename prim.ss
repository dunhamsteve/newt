...
(define (Prelude.debugStr x) (format #f "~s" x))
...
(define (Data.IORef.primNewIORef a) (lambda (w) ($IORes (box a) w)))
(define (Data.IORef.primReadIORef ref) (lambda (w) ($IORes (unbox ref) w)))
...
(define (Prelude.fatalError msg) (raise (error #f msg)))
(define (Node.exitFailure msg)
  (display msg)
  (newline)
  (exit 1))
